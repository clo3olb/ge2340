    ...
    <main>
      <Article title="Experiments">
        <p>
          ...
          for the classic machine learning algorithms. Also this work has Hakan
          Ozen's work on{" "}
          <Link href="https://www.kaggle.com/code/hakanozen/face-recognition-by-lr-rforest-knn-and-cnn">
            Face Recognition with CNN
          </Link>{" "}
          for the structure of the layers used in the CNN model.
        </p>
        <h1>Input</h1>
        <p>
        ...
        <p>
          ...
          Gaussian noise is generated using the numpy.random.normal function. We
          used scale of 0.01 in this experiment, while we have also tried to
          apply noise with gaussian scale of 0.05 in the report.
        </p>
        <Code
          language="python"
          code={`
...
plt.show()
        ...
        <p>
          ...
          (PCA) to a collection of face images. These eigen faces represent the
          principal components or features extracted from the dataset. While
          eigen faces themselves are essentially vector-based images, they offer
          valuable insights into the underlying patterns and variations in the
          data. Although eigen faces are not inherently special, they can
          exhibit certain recognizable features that resemble common attributes
          such as glasses or prominent eyebrows. These seemingly "explainable"
          features can arise from the fact that the eigen faces capture the most
          significant variations in the face images, including variations
          related to specific facial characteristics. Consequently, eigen faces
          ...
          categorized. Despite their simplicity as vector images, eigen faces
...
`}
        ...
        <p>
          ...
          Principal Component Analysis (PCA) to extract eigen faces from images.
          In our trial , 90 eigen faces were extracted from PCA and applied to
          multiple classifiers for face recognition. Interestingly, some eigen
          faces displayed explainable features, such as distinctive eyebrows,
          which contributed to the interpretability of the learned features. The
          use of PCA significantly accelerated the face recognition process,
          reducing the time taken by almost half. While the total time taken by
          six classifiers to complete face recognition using eigen faces
          extracted from PCA was 17.9 seconds, the same process took 35.6
          seconds without the use of eigen faces. The accuracy scores for both
          normal and noisy datasets, showcasing the robustness of the PCA-based
          approach across diverse scenarios. This highlights the potential of
          PCA in improving the efficiency and accuracy of facial recognition
          systems.
        </p>
        <h2>Factors Influencing Accuracy</h2>
        <p>
        ...
        <p>
          ...
          algorithms. The experiment showed that the eigen faces generated from
